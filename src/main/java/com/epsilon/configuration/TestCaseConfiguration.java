...
public class TestCaseConfiguration {
	...
	private static String executableTestPath = System.getProperty("user.dir")+"/src/test/java/com/epsilon/testCases/ExecutableTest.java";
	...
	public static void writePackageAndImportsAndClassName(String className) {
		try {
			writer.write("package com.epsilon.testCases;\n");
			writer.write("import org.testng.annotations.Test;\n");
			writer.write("import com.epsilon.configuration.Global;\n");
